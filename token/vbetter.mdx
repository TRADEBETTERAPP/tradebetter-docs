...
When `vBETTER` trades at a premium, the protocol can mint and sell `vBETTER` to capture the spread. Thirty per cent of net arbitrage profits are used to buy and burn `$BETTER`.
